...
## 🚀 Tech Stack (a.k.a things I fight with daily)
...
![RateLimit](https://img.shields.io/badge/Rate_Limiter-FF4444?style=for-the-badge)
...
- 🧾 **Full MERN Ticketing System**  
  – role-based (student/staff/admin)  
  – comments + status flow + rate limiter  
  – image uploads via Cloudinary  
  – JWT auth + httpOnly cookies  
  – staff dashboards with routing automation  

- 🛒 **POS Inventory System (Java)**  
  – cart, discounts, sales reports, receipt system  
